...
# ---- Required packages for workflow ----
...
BiocManager::install(c("phyloseq", "DESeq2", "dada2", "GenomicFeatures", "hpgltools"))
...
pkgs <- c("caret", "caretEnsemble", "e1071", "ggplot2", "ggmap", "maps",
          ...
          "reshape2", "devtools", "rlang", "Rcpp", "csv", "tibble", "plotly",
          "phyloseq", "DESeq2", "dada2", "microbiomeSeq", "GenomicFeatures", "hpgltools") # Load the PM package where all data is stored compressed for easy accessibility.
