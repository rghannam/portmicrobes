...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, trimLeft=10, truncLen=c(280,190),
...
saveRDS(seqtab, file="../output/seqtabRun1.rds")
saveRDS(seqtab.nochim, file="../output/seqtabNoCRun1.rds")

# Save the environment for sequencing run 1
save(list = ls(), file = "../output/dada2run1.Rdata")
...
# =========================================================
#       Refer to line 6 for the annotations of code.
# =========================================================
...
saveRDS(seqtab, file="../output/run2/seqtabRun2.rds")
saveRDS(seqtab.nochim, file="../output/run2/seqtabNoCRun2.rds")

save(list = ls(), file = "../output/run2/dada2run2.Rdata")
...
saveRDS(seqtab, file="../output/run3/dir/seqtabRun3.rds")
saveRDS(seqtab.nochim, file="../output/run3/dir/seqtabNoCRun3.rds")

save(list = ls(), file = "../output/run3/dir/dada2run3.Rdata")
...
seqtab1 <- readRDS("~/pm_workflow/.../input/run1/seqtabRun1.rds")
seqtab2 <- readRDS("~/pm_workflow/.../input/run1/seqtabRun2.rds")
seqtab3 <- readRDS("~/pm_workflow/.../input/run1/seqtabRun3.rds")
...
dim(seqtabmergedNoC) #1514 x 157986
# Assign taxonomy
taxa <- assignTaxonomy(seqtabmergedNoC, "~/pm_workflow/.../input/Training/silva_nr_v132_train_set.fa", multithread=TRUE)
head(taxa)
dim(taxa)
...
write.csv(trackmerged, file = "~/pm_workflow/.../output/trackmerged.csv")
saveRDS(seqtab.all, file= "~/pm_workflow/.../output/seqtaball.rds")
saveRDS(seqtabmergedNoC, file="../output/seqtabmergedNoC.rds")

saveRDS(taxa, file="../output/taxa.rds")
saveRDS(taxasp, file="../output/taxasp.rds")
